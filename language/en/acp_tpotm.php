...
$lang = array_merge($lang, [
	...
	'ACP_TPOTM_TTL_MODE'					=>	'The dynamic automatic cache: when this option is ON it overrides the second choice selected by the drop down box. Dynamic cache takes care of the Leap years and automatically re starts at the very begin of each month. If you want to disable this cache select NO and NO CACHE in the dropdown as well.',
